...
PlayAnimEx(playerid, const animlib[], const animname[], Float:fDelta, bool:loop, bool:lockx, bool:locky, bool:freeze, time, bool:forcesync)
{
...
{
	if(GetPVarInt(playerid, "Injured") != 0) return 1;
...
CMD:bodypush(playerid, params[])
{
    ...
    ApplyAnimation(playerid,"GANGS","shake_cara",4.0,false,false,false,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"GANGS","shake_carSH",4.0,false,false,false,false,0);
	return 1;
}
...
CMD:seat(playerid, params[])
{
    ...
    {
    case 1: PlayAnimEx(playerid, "ped", "SEAT_idle", 4.0, true, false, false, false, 0, true);
    case 2: PlayAnimEx(playerid, "ped", "SEAT_up", 4.0, false, false, false, false, 0, true);
...
{
    if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "RIOT", "RIOT_ANGRY", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
CMD:shake(playerid, params[])
{
    ...
    switch(strval(params))
    {
    case 1: PlayAnimEx(playerid, "GANGS", "hndshkaa", 4.0, false, false, false, false, 0, true);
    case 2: PlayAnimEx(playerid, "GANGS", "hndshkba", 4.0, false, false, false, false, 0, true);
    case 3: PlayAnimEx(playerid, "GANGS", "hndshkfa", 4.0, false, false, false, false, 0, true);
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"WAYFARER","WF_Fwd",4.0,false,false,false,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"FIGHT_C","FightC_M",4.0,false,true,true,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"POLICE","Door_Kick",4.0,false,false,false,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"PED","BIKE_elbowL",4.0,false,false,false,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"FIGHT_D","FightD_3",4.0,false,true,true,false,0);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    ApplyAnimation(playerid,"SWORD","sword_block",50.0,false,true,true,true,1);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
   	PlayAnim(playerid, "BOMBER", "BOM_Plant", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
	PlayAnimEx(playerid, "RAPPING", "Laugh_01", 4.0, true, false, false, false, 0, true);
	return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
   	PlayAnim(playerid, "SHOP", "ROB_Shifty", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "SHOP", "ROB_Loop_Threat", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "SWEET", "sweet_ass_slap", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "CRACK", "crckdeth2", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "PED", "fucku", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "PARK", "Tai_Chi_Loop", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "BAR", "dnk_stndF_loop", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "COP_AMBIENT", "Coplook_watch", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "AIRPORT", "thrw_barl_thrw", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "BD_FIRE", "BD_Panic_01", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "MEDIC", "CPR", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "Freeweights", "gym_free_celebrate", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "goggles", "goggles_put_on", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "GRAVEYARD", "mrnF_loop", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnim(playerid, "GRENADE", "WEAPON_throw", 4.0, false, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "SHOP", "SHP_Rob_GiveCash", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "SWAT", "gnstwall_injurd", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "GYMNASIUM", "GYMshadowbox", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "BD_FIRE", "wash_up", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "MISC", "Scratchballs_01", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "ON_LOOKERS", "Pointup_loop", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "PAULNMAC", "wank_out", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
{
	if(!IsAblePedAnimation(playerid)) return 1;
    PlayAnimEx(playerid, "PED", "endchat_01", 4.0, true, false, false, false, 0, true);
    return 1;
}
...
CMD:rap(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "RAPPING", "RAP_A_Loop", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "RAPPING", "RAP_B_Loop", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "RAPPING", "RAP_C_Loop", 4.0, true, false, false, false, 0, true);
...
CMD:chat(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "PED", "IDLE_CHAT", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "GANGS", "prtial_gngtlkA", 4.0, true, false, false, false, 0, true);
	case 3:	PlayAnimEx(playerid, "GANGS", "prtial_gngtlkB", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "GANGS", "prtial_gngtlkE", 4.0, true, false, false, false, 0, true);
	case 5: PlayAnimEx(playerid, "GANGS", "prtial_gngtlkF", 4.0, true, false, false, false, 0, true);
	case 6: PlayAnimEx(playerid, "GANGS", "prtial_gngtlkG", 4.0, true, false, false, false, 0, true);
	case 7:	PlayAnimEx(playerid, "GANGS", "prtial_gngtlkH", 4.0, true, false, false, false, 0, true);
...
CMD:gesture(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnim(playerid, "GHANDS", "gsign1", 4.0, false, false, false, false, 0, true);
	case 2: PlayAnim(playerid, "GHANDS", "gsign1LH", 4.0, false, false, false, false, 0, true);
	case 3: PlayAnim(playerid, "GHANDS", "gsign2", 4.0, false, false, false, false, 0, true);
	case 4: PlayAnim(playerid, "GHANDS", "gsign2LH", 4.0, false, false, false, false, 0, true);
	case 5: PlayAnim(playerid, "GHANDS", "gsign3", 4.0, false, false, false, false, 0, true);
	case 6: PlayAnim(playerid, "GHANDS", "gsign3LH", 4.0, false, false, false, false, 0, true);
	case 7: PlayAnim(playerid, "GHANDS", "gsign4", 4.0, false, false, false, false, 0, true);
	case 8: PlayAnim(playerid, "GHANDS", "gsign4LH", 4.0, false, false, false, false, 0, true);
	case 9: PlayAnim(playerid, "GHANDS", "gsign5", 4.0, false, false, false, false, 0, true);
	case 10: PlayAnim(playerid, "GHANDS", "gsign5", 4.0, false, false, false, false, 0, true);
	case 11: PlayAnim(playerid, "GHANDS", "gsign5LH", 4.0, false, false, false, false, 0, true);
	case 12: PlayAnim(playerid, "GANGS", "Invite_No", 4.0, false, false, false, false, 0, true);
	case 13: PlayAnim(playerid, "GANGS", "Invite_Yes", 4.0, false, false, false, false, 0, true);
	case 14: PlayAnim(playerid, "GANGS", "prtial_gngtlkD", 4.0, false, false, false, false, 0, true);
	case 15: PlayAnim(playerid, "GANGS", "smkcig_prtl", 4.0, false, false, false, false, 0, true);
...
CMD:lay(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "BEACH", "bather", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "BEACH", "Lay_Bac_Loop", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "BEACH", "SitnWait_loop_W", 4.0, true, false, false, false, 0, true);
...
CMD:wave(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "ON_LOOKERS", "wave_loop", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "KISSING", "gfwave2", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "PED", "endchat_03", 4.0, true, false, false, false, 0, true);
...
CMD:signal(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "POLICE", "CopTraf_Come", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "POLICE", "CopTraf_Stop", 4.0, true, false, false, false, 0, true);
...
CMD:nobreath(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "SWEET", "Sweet_injuredloop", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "PED", "IDLE_tired", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "FAT", "IDLE_tired", 4.0, true, false, false, false, 0, true);
...
CMD:getjiggy(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "DANCING", "DAN_Down_A", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "DANCING", "DAN_Left_A", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "DANCING", "DAN_Loop_A", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "DANCING", "DAN_Right_A", 4.0, true, false, false, false, 0, true);
	case 5: PlayAnimEx(playerid, "DANCING", "DAN_Up_A", 4.0, true, false, false, false, 0, true);
	case 6: PlayAnimEx(playerid, "DANCING", "dnce_M_a", 4.0, true, false, false, false, 0, true);
	case 7: PlayAnimEx(playerid, "DANCING", "dnce_M_b", 4.0, true, false, false, false, 0, true);
	case 8: PlayAnimEx(playerid, "DANCING", "dnce_M_c", 4.0, true, false, false, false, 0, true);
	case 9: PlayAnimEx(playerid, "DANCING", "dnce_M_c", 4.0, true, false, false, false, 0, true);
	case 10: PlayAnimEx(playerid, "DANCING", "dnce_M_d", 4.0, true, false, false, false, 0, true);
...
CMD:stripclub(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "STRIP", "PLY_CASH", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "STRIP", "PUN_CASH", 4.0, true, false, false, false, 0, true);
...
CMD:smoke(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnim(playerid, "SMOKING", "M_smk_in", 4.0, false, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "SMOKING", "M_smklean_loop", 4.0, true, false, false, false, 0, true);
...
CMD:dj(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "SCRATCHING", "scdldlp", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "SCRATCHING", "scdlulp", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "SCRATCHING", "scdrdlp", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "SCRATCHING", "scdrulp", 4.0, true, false, false, false, 0, true);
...
CMD:reload(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnim(playerid, "BUDDY", "buddy_reload", 4.0, false, false, false, false, 0, true);
	case 2: PlayAnim(playerid, "PYTHON", "python_reload", 4.0, false, false, false, false, 0, true);
...
CMD:tag(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "GRAFFITI", "graffiti_Chkout", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "GRAFFITI", "spraycan_fire", 4.0, true, false, false, false, 0, true);
...
CMD:deal(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "DEALER", "DEALER_DEAL", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "DEALER", "shop_pay", 4.0, true, false, false, false, 0, true);
...
CMD:crossarms(playerid, params[])
{
	...
	case 2: PlayAnimEx(playerid, "DEALER", "DEALER_IDLE", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "GRAVEYARD", "mrnM_loop", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "GRAVEYARD", "prst_loopa", 4.0, true, false, false, false, 0, true);
...
CMD:cheer(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "ON_LOOKERS", "shout_01", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "ON_LOOKERS", "shout_02", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "ON_LOOKERS", "shout_in", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "RIOT", "RIOT_ANGRY_B", 4.0, true, false, false, false, 0, true);
	case 5: PlayAnimEx(playerid, "RIOT", "RIOT_CHANT", 4.0, true, false, false, false, 0, true);
	case 6: PlayAnimEx(playerid, "RIOT", "RIOT_shout", 4.0, true, false, false, false, 0, true);
	case 7: PlayAnimEx(playerid, "STRIP", "PUN_HOLLER", 4.0, true, false, false, false, 0, true);
	case 8: PlayAnimEx(playerid, "OTB", "wtchrace_win", 4.0, true, false, false, false, 0, true);
...
CMD:sit(playerid, params[])
{
	...
	case 1: PlayAnimEx(playerid, "BEACH", "bather", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "BEACH", "Lay_Bac_Loop", 4.0, true, false, false, false, 0, true);
	case 3: PlayAnimEx(playerid, "BEACH", "ParkSit_W_loop", 4.0, true, false, false, false, 0, true);
	case 4: PlayAnimEx(playerid, "BEACH", "SitnWait_loop_W", 4.0, true, false, false, false, 0, true);
	case 5: PlayAnimEx(playerid, "BEACH", "ParkSit_M_loop", 4.0, true, false, false, false, 0, true);
...
CMD:siteat(playerid, params[])
{
	...
	switch(strval(params))
	{
	case 1: PlayAnimEx(playerid, "FOOD", "FF_Sit_Eat3", 4.0, true, false, false, false, 0, true);
	case 2: PlayAnimEx(playerid, "FOOD", "FF_Sit_Eat2", 4.0, true, false, false, false, 0, true);
...
CMD:bar(playerid, params[])
{
	...
	case 2: PlayAnim(playerid, "BAR", "Barserve_bottle", 4.0, false, false, false, false, 0, true);
	case 3: PlayAnim(playerid, "BAR", "Barserve_give", 4.0, false, false, false, false, 0, true);
	case 4: PlayAnim(playerid, "BAR", "dnk_stndM_loop", 4.0, false, false, false, false, 0, true);
	case 5: PlayAnimEx(playerid, "BAR", "BARman_idle", 4.0, true, false, false, false, 0, true);
