...
{
    mysql_function_query(MainPipeline, "SELECT * FROM trucker_company WHERE id = 0", true, "OnLoadTruckerCompany", "");
}
...
{
    mysql_function_query(MainPipeline, "SELECT * FROM trucker_company_members WHERE company_id = 0", true, "OnLoadTruckerCompanyMembers", "");
}


stock LoadTruckerCertifiedVehicles()
{
    mysql_function_query(MainPipeline, "SELECT vehicle_id, vehicle_name, grant_time FROM trucker_cert_vehicles", true, "OnLoadTruckerCertifiedVehicles", "");
}
