...
stock CreateDealershipTextDraws(playerid)
{
    ...
    // Elegant subtitle
    DealershipTD[playerid][46] = CreatePlayerTextDraw(playerid, 160.0, 90.0, "~w~Timeless Elegance • Premium Collection");
    ...
    // Premium accent
    DealershipTD[playerid][45] = CreatePlayerTextDraw(playerid, 160.0, 300.0, "~y~★ ~w~LUXURY ~y~★");
