...
#define			SIREN_SOUND					"http://sampweb.ng-gaming.net/brendan/siren.mp3"
			/*  ---------------- TIMERS ----------------- */
...
#define MAX_INVENTORY_SLOTS     35
#define MAX_INVENTORY_WEIGHT    300.0
