...
public LoadStreamerDynamic3DTextLabels()
{
    ...
    CreateDynamic3DTextLabel("Su Dung /laybanh de nhan banh \nDe co Pizza giao hang!",COLOR_YELLOW,-1713.961425, 1348.545166, 7.180452, 4.0); //getpizza
...
public LoadStreamerDynamicObjects()
{
	...
	SetObjectMaterialText(vipsf, "{FF0000}G{6C6E70}v {FF0000}C{6C6E70} Group {FF38AF}VIP", 0, 130, "Times New Roman", 30, false, -16776961, 0,OBJECT_MATERIAL_TEXT_ALIGN_CENTER);
